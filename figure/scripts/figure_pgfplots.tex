...
%
% PROVENIENZA DATI:
%   - Sorgente autoritativa delle matrici 2x2 (bond, equity) per evento e
%     controllo nella cella NFP/neg:
%       results/01_protocol_v2/full_moments_2x2/nfp_neg_moments_2x2.json
%     Deposito generato dallo script
%       results/01_protocol_v2/full_moments_2x2/extract_full_moments.py
%     riassemblando i cluster del pacchetto `protocol_v2` con stesso seed
%     `execute_v2_signflip_2026-06-22` (master_seed = 20260621) sui dati
%     Refinitiv intraday (proprietary, fuori dalla repo pubblica).
%   - Validazione del deposito: i campi b_OLS, var_b (event/control),
%     cov(b,e) (event/control) e r_hat sono stati confrontati a tol=1e-9 con
%     results/01_protocol_v2/beta_H_robust_cells_w15.json (24/24 confronti
%     passati; vedi full_moments_2x2/manifest.json).
%   - Quantita' (in scala log-return, le bps si ottengono *1e4):
%     b_OLS_event = -0.7855, var_b_event = 7.5740e-6 (= 757.4 bps^2)
%     var_b_control = 4.9217e-7 (= 49.2 bps^2)
%     cov_b_e_event = -5.9494e-6 (= -594.94 bps^2)
%     cov_b_e_control = -2.2867e-7 (= -22.87 bps^2)
%     r_hat = var_b_event/var_b_control = 15.3890
%     beta_H = Delta Cov / Delta Var = -0.8078 (SE_boot = 0.1617,
%             F_eff = 53.13) -- dal file beta_H_robust_cells_w15.json.
%     var_e_event = 1.5731e-5 (= 1573.06 bps^2)
%     var_e_control = 1.2640e-6 (= 126.40 bps^2)
%     n_e = 145, n_c = 574.
%
