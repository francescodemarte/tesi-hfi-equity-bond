...
if [ ! -f "data/external_public/jk_surprises_fomc.csv" ]; then
    ...
    echo "  Salvare come data/external_public/jk_surprises_fomc.csv"
fi
...
echo ""
echo "Setup completato. Per i dati intraday Refinitiv vedere data/intraday/.gitkeep"
